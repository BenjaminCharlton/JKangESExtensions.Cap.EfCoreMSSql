...
namespace JKang.EventSourcing.Persistence.EfCore
{
    ...
    public class EventStoreDecorator<TEventDbContext, TAggregate, TKey> : EventStoreCapDecoratorBase<TAggregate, TKey>
        where TEventDbContext : DbContext, IEventDbContext<TAggregate, TKey>
        where TAggregate : IAggregate<TKey>
    {
        private readonly TEventDbContext _context;
        private readonly IMapDomainEventsToIntegrationEvents _domainEventToIntegrationEventMappings;
        ...
        public EventStoreDecorator(EfCoreEventStore<TEventDbContext, TAggregate, TKey> inner,
            ...
            base(inner, publisher)
        {
            ...
            _domainEventToIntegrationEventMappings = domainEventToIntegrationEventMappings ?? new DomainEventsToIntegrationEventsMap();
        }
